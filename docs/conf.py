...
# built documents.
#
# The full version, including alpha/beta/rc tags, read from package metadata.
release = get_version("smact")
...
latex_documents = [
    (master_doc, "smact.tex", "smact Documentation", "Author", "manual"),
]
...
man_pages = [(master_doc, "smact", "smact Documentation", [author], 1)]
