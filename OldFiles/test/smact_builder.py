...
def cubic_perovskite(species,cell_par=[6,6,6,90,90,90]):
	 system = crystal((species), 
	 basis=[(0,0,0), (0.5, 0.5, 0.5), (0.5, 0.5, 0)],
         spacegroup=221, cellpar=cell_par)
	
         return system

def spinel(species, cell_par=[8,8,8,90,90,90]):
	 system = crystal((species),
	 basis=[(0.0, 0.0, 0.0),(0.625, 0.625, 0.625),(0.3873, 0.3873, 0.3873)],
	 spacegroup=227,cellpar=cell_par)
