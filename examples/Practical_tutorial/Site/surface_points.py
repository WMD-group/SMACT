    ...
    if miller in exists:
        ...
        surfaces["100"] = (
            ...
            ([0.25, 0.2], [0.5, 0.25], [0.5, 0.75],
             [0.7, 0.7], [0.5, 1.0], [1.0, 1.0]),
            (),
        )
        surfaces["110"] = ([0.5, 0.3], [0.75, 0.3], [
                           1.0, 0.8], [0.75, 0.80]), ()
        return surfaces[miller]
    else:
        print(
...
def perovskite(miller):
    ...
    if miller in exists:
        surfaces = {}
        surfaces["100"] = ([0, 0], [0.5, 0.5]), ([0.5, 0],
                                                 [0, 0.5], [0.5, 0.5]), ()
...
def zincblende(miller):
    ...
    if miller in exists:
        ...
        surfaces["110"] = ([0.25, 0.9], [0.25, 0.4], [
                           0.5, 0.7], [0.5, 0.2]), ()
        return surfaces[miller]
    else:
        print(
...
def CuIz(miller):
    ...
    if miller in exists:
        ...
        surfaces["110"] = ([0.25, 0.9], [0.25, 0.4], [
                           0.5, 0.7], [0.5, 0.2]), ()
        surfaces["011"] = ([0.25, 0.9], [0.25, 0.4], [
                           0.5, 0.7], [0.5, 0.2]), ()
        return surfaces[miller]
    else:
        print(
...
def bixybite(miller):
    ...
    if miller in exists:
        surfaces = {}
        surfaces["100"] = (
            ([0.2, 0.9], [0.6, 0.9], [0.9, 0.6],
             [0.4, 0.4], [0.9, 0.4], [0.7, 0.1]),
            (
                [0.2, 0.2],
                [0.2, 0.7],
                [0.7, 0.2],
